...
It seems that the glandular areas tend to be more homogeneous. 
...
That's interesting. It seems that locally we can have a mixture of positive and negative spatial autocorrelation, though for the most part local Moran's I is not statistically significant.
...
```{r, fig.width=6, fig.height=3}
moranPlot(sfe, "nCounts", binned = TRUE, plot_influential = FALSE) 
```

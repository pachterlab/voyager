...
```{r}
plotCellBin2D(sfe, hex = TRUE, bins = 150)
```
...
```{r}
bbox1 <- c(xmin = 5000, xmax = 6000, ymin = -1500, ymax = -500)
bbox2 <- c(xmin = 1000, xmax = 2000, ymin = -2250, ymax = -1250)
```

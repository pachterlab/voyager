...
As including a more detailed vignette inside the package makes the package exceed the tarball size, more detailed vignettes will be hosted on an external website. This is a simplified vignette.

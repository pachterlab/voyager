...
Cons:
* Fewer datasets available compared to other single cell technologies
...
|--------------------|:---------------:|---------------------------------|
| [Preprocess raw data](https://pachterlab.github.io/voyager/dev/articles/preprocess_splitseq.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation-devel/vignettes/preprocess_splitseq.ipynb) | Fetch reference data with `gget`, process raw data with `seqspec`, generate a count matrix with `kallisto-bustools`|
...
| Vignette          |   Colab Notebook   | Description                   |
  |-------------------|:------------------:|-------------------------------|
  | [SPLiT-seq Basic QC](https://pachterlab.github.io/voyager/dev/articles/vig9_splitseq.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation-devel/vignettes/vig9_splitseq.ipynb) | Basic qc and preprocessing |

...
|--------------------|:---------------:|---------------------------------|
| [Create a `SpatialFeatureExperiment` object](https://pachterlab.github.io/voyager/articles/create_sfe.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation/vignettes/create_sfe.ipynb) | Download data, create `SFE` object, perform basic QC |
|[Create a `SpatialFeatureExperiment` from scratch](https://pachterlab.github.io/voyager/articles/create_sfe_v2.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation/vignettes/create_sfe_v2.ipynb) | Download data from GEO using `ffq`, create `SFE` object, perform basic QC |

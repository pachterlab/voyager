...
|--------------------|:---------------:|---------------------------------|
| [Create a `SpatialFeatureExperiment` object](https://pachterlab.github.io/voyager/articles/create_sfe.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation-devel/vignettes/create_sfe.ipynb) | Download data, create `SFE` object, perform basic QC |
|[Create a `SpatialFeatureExperiment` from scratch](https://pachterlab.github.io/voyager/articles/create_sfe_v2.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation-devel/vignettes/create_sfe_v2.ipynb) | Download data from GEO using `ffq`, create `SFE` object, perform basic QC |
...
| Vignette | Colab Notebook | Description |
|--------------------|:---------------:|---------------------------------|
| [Slide-seqV2 exploratory data analysis](https://pachterlab.github.io/voyager/articles/vig3_slideseq_v2.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation-devel/vignettes/vig3_slideseq_v2.ipynb) | Perform basic QC, data normalization, dimension reduction, compute Moran's I|

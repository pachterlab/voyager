...
Here we plot aspect ratio and mean intensity of cells stains and markers, which have not been plotted before. PanCK is a marker for epithelial cells. CD45 is a leukocyte marker. CD3 is a T cell marker. This plot takes a while to show since it would take any program quite a while to plot over 100,000 polygons 6 times.
...
The first PC highlights the epithelium. PC2 highlights T cells. PC4 might highlight other leikocytes. Need to check the genes with the highest loadings to find what the other PCs mean.

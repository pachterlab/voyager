...
system("gunzip cellatlas/examples/atac-10xmultiome/cellatlas_out/*gz")
ad <- read_h5ad("cellatlas/examples/atac-10xmultiome/cellatlas_out/adata.h5ad")
```

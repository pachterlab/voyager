...
```{r}
plotSpatialFeature(sfe, c("sum", "detected"))
```
...
```{r}
plotSpatialFeature(sfe_tissue, features = "cluster", colGeometryName = "spotPoly")
```
...
More spatial analyses on this dataset is performed in [an "advanced" version of this vignette](https://pachterlab.github.io/voyager/dev/articles/visium_10x_spatial.html).

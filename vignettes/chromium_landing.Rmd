...
=======
| [Preprocess raw data](https://pachterlab.github.io/voyager/dev/articles/preprocess_10xv3.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation-devel/vignettes/preprocess_10xv3.ipynb) | Fetch reference data with `gget`, process raw data with `seqspec`, generate a count matrix with `kallisto-bustools`|
| [Create a `SFE` object](https://pachterlab.github.io/voyager/articles/create_sfe.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation-devel/vignettes/create_sfe.ipynb) | Download data, create `SFE` object |
>>>>>>> documentation-devel
## Analysis Workflows
...
| Vignette          |   Colab Notebook   | Description                   |
  ...
  | [10X v3 Basic](https://pachterlab.github.io/voyager/articles/nonspatial.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation/vignettes/nonspatial.ipynb) | Standard analyses for non-spatial scRNA-seq data |
   | [ClickTag Basic QC](https://pachterlab.github.io/voyager/articles/vig11_clicktags.html) | [Colab Notebook](https://colab.research.google.com/github/pachterlab/voyager/blob/documentation/vignettes/vig11_clicktags.ipynb) | Standard QC for scRNA-seq data |
